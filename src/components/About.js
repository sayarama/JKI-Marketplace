  ...
  return (
    <>
      <Navbar bg="light" expand={false}>
        <Container fluid>
          <Link className="headLogo" to="/home">
            JKIMarketplace
          </Link>
          ...
          >
            ...
            <Offcanvas.Body>
              <Nav className="justify-content-end flex-grow-1 pe-3">
                <Link className="fitur" to="/about">
                  About
                </Link>
                <Link className="fitur" to="/features">
                  Features
                </Link>
              </Nav>
            </Offcanvas.Body>
      ...
      <Container>
        <Row>
          <Col>
            <h1>Tentang Kami</h1>
            <p>
              Kami memulai fokus dalam pelatihan Soft Skill & Hard Skill sejak
              2011, terus bertumbuh lebih baik lagi hingga saat ini dalam
              PT.Jaya Konsultan Indonesia. Dengan Superteam, Motivator, Coach &
              Tutor yang berpengalaman Lebih dari Sepuluh Tahun dalam dunia
              ...
              berfokus pada pelatihan dan pengembangan Soft Skill, Hard Skill
              serta menyediakan produk da jasa yang berkualitas serta mengikuti
              perkembangan dan teknologi. Kami yakin sepenuhnya bahwa Setiap
              Perusahaan, Lembaga yang maju karena yang dibangun Prioritas
              adalah kualitas manusianya. Kami akan terus tumbuh bersama Anda
