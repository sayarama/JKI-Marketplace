  ...
  return (
    <>
      <Navbar bg="light" expand={false}>
        <Container fluid>
          <Navbar.Brand className="headLogo" href="#">
            JKI Marketplace
          </Navbar.Brand>
        ...
        <div className="inner-content">
          <div className="image">
            ...
            <p>
              ...
              <Link className="selengkapnya" to="/features">
                Selengkapnya
              </Link>
            </p>
          </div>
      ...
      <div className="section">
        ...
        <div>
          ...
          <p>
            ...
            2011, terus bertumbuh lebih baik lagi hingga saat ini dalan PT.Jaya
            Konsultan Indonesia.
          </p>
      ...
      <div className="sectionChild">
        ...
        <div>
          <p>
            Pt.Jaya Konsultan Indonesia,fokus pada manfaat Karena Kami yakin
            Sukses yang sebenarnya adalah bagaimana kita memberi manfaat dan
            mambahagiakan banyak orang-orang.Semoga kita dapat bersinergi dan
            memberikan banyak manfaat untuk seluruh orang
          </p>
        </div>
      </div>
      ...
      <footer>Copyright 2022 Pt.Jaya Konsultan Indonesia - Kelompok 1 XI-RPL-1</footer>
    </>
  );
}
